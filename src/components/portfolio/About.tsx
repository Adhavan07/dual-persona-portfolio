      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="bg-card border border-primary/30 rounded p-6 neon-border">
              <div className="flex items-center gap-2 mb-4 text-primary/60 font-mono text-sm">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {skills.map((skill, index) => (
                <div
                  key={skill.name}
                  className="group flex items-center gap-3 p-3 bg-card border border-primary/20 rounded hover:border-primary/60 hover:bg-primary/5 transition-all duration-300"
